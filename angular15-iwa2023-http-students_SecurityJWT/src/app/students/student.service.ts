...
export class StudentService {
  ...
  addStudenttodatabase(student: { firstname: any; telephone: any; email: any; lastname: any }): Observable<Student> {
 ...
 /* GET students matching the search term*/

  searchStudents(term: string): Observable<Student[]> {
    const url = `${this.studentsUrl}?firstname=${term}&lastname=${term}`; // Assuming the server supports searching with 'q' parameter
    return this.http.get<Student[]>(url).pipe(
